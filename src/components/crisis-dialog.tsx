      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="pt-4">
            It sounds like you're going through a very difficult time. Please know that immediate support is available and you don't have to go through this alone.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <div className="space-y-4 py-4">
          <p className="font-semibold">Please reach out to a professional helpline now:</p>
